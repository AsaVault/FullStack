...
{
    [DbContext(typeof(BookWatchContext))]
    partial class BookWatchContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("DutchTreat.Data.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            OrderDate = new DateTime(2020, 9, 2, 18, 11, 14, 286, DateTimeKind.Utc).AddTicks(8447),
                            OrderNumber = "1234"
                        });
                });
